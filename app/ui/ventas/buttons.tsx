...
import { deletePet, deleteSell } from '@/app/lib/actions';
...
export function DeleteSell({ id }: { id: string }) {
  const deleteSellWithID = deleteSell.bind(null, id);
  return (
    <form action={deleteSellWithID}>
